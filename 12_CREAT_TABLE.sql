/*
    ...
    # DML (Data Manipulation Languager, 데이터 조작어) ※ BD의 CRUD
     ...
     ※ CRUD - Create, Read, Update, Delete, 모든 프로그램에는 CRUD가 다양한 형태로 존재한다
...
*/
 ...
 -- CREATE TABLE 테이블명 (컬럼이름1 컬럼타입1, 컬럼이름, 컬럼타입2 ...);
...
/*
    ...
    # 데이터 딕셔너리
     ...
     - 데이터에 대한 데이터(메타 데이터)
     - BD는 우리가 추가한 무언가를 알아서 관리한다
     - 현재 상태는 BD의 데이터 딕셔너리를 통해서만 알 수 있다
