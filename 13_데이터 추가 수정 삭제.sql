...
-- 컬럼명을 생각하고 데이터 추가하기 (반드시 모든 데이터를 컬럼 순서대로 넣어줘야한다)
INSERT INTO coffees VALUES(6, '눈꽃빙수', 6500);
INSERT INTO coffees VALUES(7, '딸기빙수', 6500);

-- 컬럼명을 모두 적어주면 순서는 상관 없다
...
-- 연습 1 : 빙수도 아니고, 아메리카노도 아닌 모든 제품들의 가격을 3천원으로 수정해보세요

UPDATE coffees SET price = 3000 WHERE cname NOT IN ('딸기빙수', '아메리카노', '아이스 아메리카노', '망고빙수', '눈꽃빙수', '팥빙수');  
...
/*
    ...
    # 테이블 데이터 삭제하기
     ...
     - 행 전체를 삭제한다. (특정 컬럼 값만 삭제하는 것은 UPDATE에 해당한다)
     - DELETE 삭제 조건이 없으면 모든 행을 삭제한다
